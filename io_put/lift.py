...
if __name__ == '__main__':
    ...
    code=code1=f"lol-x-his30{str(code_number)}"
    # code="lol-x-his30147"
    code="lol-x-test"
    filename=f"/home/kentr/Assignment/Tools/WeSay/{code}/{code1}.lift"
...
# for code in [100,101,102,231,253,242,243]: #103#240#242#243 #100,101,102,231,253,255
    ...
    #                             analang='ln-CD')
    kwargs={'expressions':['nttt',"yi",'ɑɑ','aa',"mwãsasi","ggg", "yyy", "eee", "iii","ɔɔɔ",'ooo','lll','aaa','sss','---','___',"555",
                            'ʔ'], #in forms
