# Pourquoi travailler avec des ordinateurs ? Une comparaison de l'utilisation de [A-Z+T](https://github.com/kent-rasmussen/azt) avec les méthodes participatives carte et crayon
