...
### Simplest install on [MS Windows](SIMPLEINSTALL.md) ([script](../installfiles/RunMeAsAdmintoInstall.bat?raw=true)) or [Linux](SIMPLEINSTALL_LINUX.md) ([script](../installfiles/RunMetoInstall_Linux.sh?raw=true))
