...
### There is an install executable for MS Windows [here](https://github.com/MaggieCampo/aztinstaller) ([direct link](https://github.com/MaggieCampo/aztinstaller/blob/master/AZT_Installer.exe?raw=true))
