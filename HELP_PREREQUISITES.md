...
- Follow the instructions [here](SIMPLEINSTALL.md) to install A→Z+T. Please work all the way down this page, and do everything on it. Don't stop unless you really can't continue. If you get stuck, please [Email me](kent_rasmussen@sil.org?subject=Please help with A→Z+T Installation) with specific questions or problems.
